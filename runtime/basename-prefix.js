(function () {
  var attributes = ['href', 'src', 'srcset', 'data-href', 'data-src', 'data-src']; /// don't run if __PATH_PREFIX__ is empty
  ...
  function fixCurrentUrls() {
    var query = attributes.reduce(function (a, b) {
      return a + '[' + b + '],';
    }, '').replace(/,$/, '');
  ...
  function fixStaticAssets() {// var basename = window.__PATH_PREFIX__;
